	...
	<div id="header" class="col-full">
   		...
   		<div id="header_container">
			...
			<div id="logo" class="fl">
		       	...
		       	<a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('description'); ?>">Grubster</a>
		   	...
		   	<div id="pagenav" class="nav fr">
		   		...
		   		<ul>
			    	...
			    	<li><a href="./category/dicas/">Dicas</a></li>
			    	<li><a href="https://www.grubster.com.br/busca">Encontre Restaurantes</a></li>
			    	<?php /*
